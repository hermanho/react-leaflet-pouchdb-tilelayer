...
import { TileLayer as LeafletTileLayer, Util, Bounds, Point, Browser } from 'leaflet'
...
const LeafletPouchDBTileLayer = LeafletTileLayer.extend({
    ...
    seed: function (bbox, minZoom, maxZoom) {
        ...
        for (let z = minZoom; z <= maxZoom; z++) {
            ...
            // );
            const tileRange = this._pxBoundsToTileRange(new Bounds([northEastPoint, southWestPoint]));
